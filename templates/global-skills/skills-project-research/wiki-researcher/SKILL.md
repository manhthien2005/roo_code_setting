...
description: "Deep 5-iteration architectural trace grounded in source code. Use when user needs in-depth system analysis spanning many files."
risk: safe
source: self
tags: [research, architecture, deep-analysis, code-tracing]
---
...
Use `codebase_search` for semantic discovery, `search_files` for exact patterns, and `read_file` to trace implementations.
